...
<body>
    ...
    <div class="wrapper">
        <form method="post" action="{{ route('moyendepayementeffectif') }}">
            @csrf
            <div class="text-center">Paiement bancaire <span class="time">ref 001</span></div>
            ...
            <div class="bg-white d-flex flex-column">
                ...
                <div class="operateur d-flex" style="gap:5px;margin-top: 10px;">
                    <div style="background-color: #4ed14e;color:white">Orange Money</div>
                    <div>MTN Money</div>
                </div>
            </div>
            ...
            <div class="bg-white mx-5">
                <div class="d-flex mx-5 space-between">
                    <div class="d-flex flex-column">
                        ...
                        <input type="hidden" name="moyen_payement" value="Orange Money">
                    </div>
                ...
                <div class="d-flex mx-5 space-between">
                    <div class="d-flex flex-column">
                        ...
                        <span style="width: 50%;">#150*11*numero*Montant#</span>
                    </div>
